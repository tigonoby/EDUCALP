			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100 validate-input" data-validate = "Ingrese su documento">
						<input class="input100" type="number" name="documento" placeholder="Número de Documento">
					...
					<div class="wrap-input100 validate-input" data-validate="Ingrese su contraseña ">
						<input class="input100" type="password" name="clave_us" placeholder="Contraseña">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Confirme contraseña ">
						<input class="input100" type="password" name="clave2" placeholder="Confirmar contraseña">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
					...
					<div class="container-login100-form-btn m-t-32">
						<button type="submit" name="boton" class="login100-form-btn">
							Registrarse
						</button>		
					</div>
